...
describe.only("handle error", () => {
  ...
  it.only("GET /songs/rubbish should throw an error", async () => {
    const response = await request(app).get("/songs/rubbish");
    expect(response.body.message).toEqual(
      "Unable to find song with id: rubbish"
    );
  });

  it("DELETE /songs/rubbish should throw an error", () => {});

  it("PUT /songs/rubbish should throw an error", () => {});
});
